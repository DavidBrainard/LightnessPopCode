...
condStr = ['dc-' decodeInfo.type '_' 'cls-' classifyStr '_' 'rf-' decodeInfo.rfAnalysisType '_' 'pca-' decodeInfo.pcaType pcaKeepStr '_' ...
    decodeInfo.trialShuffleType '_' decodeInfo.paintShadowShuffleType '_' 'lo-' decodeInfo.decodeLOOType '_' 'clo-' decodeInfo.classifyLOOType '_' decodeInfo.excludeSYelectrodes '_' 'ft-' decodeInfo.paintShadowFitType ...
