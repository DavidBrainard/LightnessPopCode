...
condStr = ['dc-' decodeInfo.type '_' 'cls-' classifyStr '_' 'rf-' decodeInfo.rfAnalysisType '_' 'pca-' decodeInfo.pcaType pcaKeepStr '_' ...
    ...
    decodeInfo.trialShuffleType '_' decodeInfo.paintShadowShuffleType '_' 'lo-' decodeInfo.looType '_' 'clo-' decodeInfo.classLooType '_' decodeInfo.excludeSYelectrodes '_' 'ft-' decodeInfo.paintShadowFitType ...
